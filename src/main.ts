  ...
  return `
    <footer class="site-footer">
      <div class="footer-links">
        ...
        <a href="https://github.com/xvoidlabs/stealth-bridge" target="_blank" rel="noopener" class="footer-link" title="GitHub">
          <svg viewBox="0 0 24 24" fill="currentColor" class="footer-icon">
        ...
        <a href="https://github.com/xvoidlabs/stealth-bridge#readme" target="_blank" rel="noopener" class="footer-link" title="Documentation">
          <svg viewBox="0 0 24 24" fill="currentColor" class="footer-icon">
